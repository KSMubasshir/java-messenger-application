...
public class Client2 {
    ...
    Client2(String username, String listening_port, String server_ip, String server_name) throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Client2 client = new Client2("Samin", "11236", "127.0.0.1", "CSE108_NetworkingAssignmentServer");
    }
}